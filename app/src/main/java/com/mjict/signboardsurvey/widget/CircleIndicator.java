...
public class CircleIndicator extends LinearLayout {
    ...
    public void setIndicatorResource(int possition, Integer resource) {
...
//        }
//
//        if(possition < 0 || possition >= count)
//            return;

        images.put(possition, resource);
    ...
    private final ViewPager.OnPageChangeListener mInternalPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        @Override public void onPageSelected(int position) {
            ...
            if (mLastPosition >= 0 && (currentIndicator = getChildAt(mLastPosition)) != null) {
                Integer img = images.get(mLastPosition);
                int resId = (img == null) ? mIndicatorBackgroundResId : img;

//                currentIndicator.setBackgroundResource(mIndicatorUnselectedBackgroundResId);
                currentIndicator.setBackgroundResource(resId);
            ...
            if (selectedIndicator != null) {
                ...
                int resId = (img == null) ? mIndicatorBackgroundResId : img;
//                if(img != null)
//                    selectedIndicator.setBackgroundResource(img);
//                else
//

//                selectedIndicator.setBackgroundResource(mIndicatorBackgroundResId);
                selectedIndicator.setBackgroundResource(resId);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if(img != null) {
                if (currentItem == i) {
                    ...
                    addIndicator(img, mImmediateAnimatorOut);
                } else {
                    Log.d("junseo", "mImmediateAnimatorIn");
                    addIndicator(img, mImmediateAnimatorIn);
                }
            } else {
    ...
    private void addIndicator(@DrawableRes int backgroundDrawableId, Animator animator) {
        ...
        lp.gravity = Gravity.CENTER_VERTICAL;   // junseo
    ...
    // junseo
    private class IndicatorImage {
        public int position;
        public Drawable image;

        public IndicatorImage(int position, Drawable image) {
